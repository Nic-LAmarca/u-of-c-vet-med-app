...
import './StudentAnimalProfile.css';
...
export default function StudentAnimalProfile() {
  const [animalId, setAnimalId] = useState(window.localStorage.getItem("animal"));
    ...
    return (
        <div className="StudentAnimalProfile-grid-container">
            <h3 className="StudentAnimalProfile-grid-item1">
                {animalName}
            </h3>
            <h3 className="StudentAnimalProfile-grid-item2">
                Status: {animalStatus}
            </h3>
            <h3 className="StudentAnimalProfile-grid-item3">
                ID # {animalId}
            </h3>
            <Table striped bordered hover className="StudentAnimalProfile-grid-item5" id="profileTable">
                <thead>
                    <tr>
                        <th>Attribute</th>
                        <th>Value</th>
            ...
            <Tab.Container id="left-tabs-example" defaultActiveKey="first" >
                ...
                <div className="StudentAnimalProfile-grid-item7">
                <Nav variant="pills"  >
                    <Nav.Item>
                ...
                <div className="StudentAnimalProfile-grid-item6">
                    <Tab.Content >
                        <Tab.Pane eventKey="first">
                        <input className="StudentAnimalProfile-comment-item1" placeholder="Enter Comment Here" onChange={(e) => setDescription(e.target.value)}></input>
                        <button className="StudentAnimalProfile-submit-item1" type="submit" onClick={addComment}>Submit</button>

                            <Table striped bordered hover className="StudentAnimalProfile-grid-item100" id="commentTable">
                                <thead>
                                    <tr>
                        ...
                        <Tab.Pane eventKey="second">
                            <h100 className="StudentAnimalProfile-photo-item1">SparkyPhoto1.png</h100>
                            <h101 className="StudentAnimalProfile-photo-item2">SparkyPhoto2.png</h101>
                            <h102 className="StudentAnimalProfile-photo-item3">SparkyPhoto3.png</h102>
                        </Tab.Pane>
                        <Tab.Pane eventKey="third">
                            <Table striped bordered hover className="StudentAnimalProfile-grid-item100">
                                <thead>
                                    <tr>

...
export default function AttendantAnimalProfile() {
   const [animalId, setAnimalId] = useState(window.localStorage.getItem("animal"));
     ...
     return (
         <div className="AttendantAnimalProfile-grid-container">
             <h3 className="AttendantAnimalProfile-grid-item1">
                 {animalName}
             </h3>
             <h3 className="AttendantAnimalProfile-grid-item2">
                 Status: {animalStatus}
             </h3>
             <h3 className="AttendantAnimalProfile-grid-item3">
                 ID # {animalId}
             </h3>
             <Table striped bordered hover className="AttendantAnimalProfile-grid-item5" id="profileTable">
                 <thead>
                     <tr>
                         <th>Attribute</th>
                         <th>Value</th>
             ...
             <Tab.Container id="left-tabs-example" defaultActiveKey="first" >
                 ...
                 <div className="AttendantAnimalProfile-grid-item7">
                 <Nav variant="pills"  >
                     <Nav.Item>
                 ...
                 <div className="AttendantAnimalProfile-grid-item6">
                     <Tab.Content >
                         <Tab.Pane eventKey="first">
                         <input className="AttendantAnimalProfile-comment-item1" placeholder="Enter Comment Here" onChange={(e) => setDescription(e.target.value)}></input>
                         <button className="AAttendantAnimalProfile-submit-item1" type="submit" onClick={addComment}>Submit</button>

                             <Table striped bordered hover className="AttendantAnimalProfile-grid-item100" id="commentTable">
                                 <thead>
                                     <tr>
                         ...
                         <Tab.Pane eventKey="second">
                             <h100 className="AttendantAnimalProfile-photo-item1">SparkyPhoto1.png</h100>
                             <h101 className="AttendantAnimalProfile-photo-item2">SparkyPhoto2.png</h101>
                             <h102 className="AttendantAnimalProfile-photo-item3">SparkyPhoto3.png</h102>
                         </Tab.Pane>
                         ...
                         <Table striped bordered hover className="AttendantAnimalProfile-grid-item100">
                             <thead>
                                 <tr>

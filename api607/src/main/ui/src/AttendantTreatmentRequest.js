...
export default function AttendantTreatmentRequest() {
    ...
    async function makeRequest(event) {
        event.preventDefault();
        await axios.post('http://localhost:8080/AttendantTreatmentRequest',
            null,
            {
                params: {
                    requestAnimalId
    ...
    return (
        ...
        <div className="AttendantTreatmentRequest-grid-container">
            <div className="AttendantTreatmentRequest-grid-item1">
                <h1> Teacher Dashboard </h1>
            </div>
            <div className="AttendantTreatmentRequest-grid-item2">
            ...
            <br/><br/>
            <DropdownButton  className= "AttendantTreatmentRequest-grid-item3" id="dropdown-basic-button" title="Animals" onClick={dropDown}  alignRight>
            ...
            <b className="AttendantTreatmentRequest-grid-item5">
                Animal Selected: {requestAnimalId}
            </b>
            <Button className="AttendantTreatmentRequest-grid-item4" onClick={makeRequest} variant="info">Send Request</Button>
            <b className="AttendantTreatmentRequest-grid-item6">
                Animal Requested: {requestAnimal}
            </b>
            <br/><br/>
            <DropdownButton  className= "AttendantTreatmentRequest-grid-item8" id="dropdown-basic-button" title="Requests" onClick={cancelDropDown}  alignRight>
                <Dropdown.Item></Dropdown.Item>
                {/*<Dropdown.Item href="#/action-2">Another action</Dropdown.Item>*/}
                {/*<Dropdown.Item href="#/action-3">Something else</Dropdown.Item>*/}
                <ul>
            ...
            <b className="AttendantTreatmentRequest-grid-item10">
                Request Selected: {cancelRequestId}
            </b>
            <Button className="AttendantTreatmentRequest-grid-item9" onClick={cancelRequest} variant="info">Cancel Request</Button>
            <b className="AttendantTreatmentRequest-grid-item11">

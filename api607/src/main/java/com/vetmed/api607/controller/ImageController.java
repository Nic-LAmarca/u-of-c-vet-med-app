...
public class ImageController {
    ...
    @CrossOrigin
    @PostMapping("/addImage{userId, fileN, animalId}")
    public void addImage(@PathParam("userId") int userId, @PathParam("fileN") String fileN, @PathParam("animalId") int animalId)
    {
        String separator = "\\";
        String[] paths = fileN.replaceAll(Pattern.quote(separator), "\\\\").split("\\\\");

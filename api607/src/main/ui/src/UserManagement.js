...
export default function UserManagement() {
    return (
        <div className="UserManagement-grid-container">
            ...
            <Button className = "UserManagement-grid-item3">Add User</Button>
            <Button className = "UserManagement-grid-item4">Block User</Button>
            <Button className = "UserManagement-grid-item5">Remove User</Button>
        </div>
    );
}

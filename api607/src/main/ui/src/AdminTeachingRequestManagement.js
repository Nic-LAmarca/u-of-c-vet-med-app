...
export default function AdminTeachingRequestManagement() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/adminTeachingRequests',
            null
        )
    ...
    async function updateRequest(requestId, decision) {
        ...
        axios.post('http://localhost:8080/adminTeachingRequestDecision',
             null,
             {
                 params: {
                     userId,
                        ...
                        >
                            ...
                            <Offcanvas.Body>
                                <Nav className="justify-content-end flex-grow-1 pe-3">
                                    ...
                                    <Button variant="info" href="/TeacherTeachingRequestManagement" >
                                        Teaching Request Management
                                    </Button><br/>

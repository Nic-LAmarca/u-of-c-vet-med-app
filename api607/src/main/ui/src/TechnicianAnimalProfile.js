...
import './TechnicianAnimalProfile.css';
...
export default function TechnicianAnimalProfile() {
    ...
    return (
        <div className="TechnicianAnimalProfile-grid-container">
            ...
            <Table striped bordered hover className="TechnicianAnimalProfile-grid-item5" id="profileTable">
                <thead>
                    <tr>
                        <th>Attribute</th>
                        <th>Value</th>
            ...
            <Tab.Container id="left-tabs-example" defaultActiveKey="first" >
                ...
                <div className="TechnicianAnimalProfile-grid-item6">
                    <Tab.Content >
                        ...
                        <input className="TechnicianAnimalProfile-comment-item1" placeholder="Enter Comment Here" onChange={(e) => setDescription(e.target.value)}></input>
                        <button className="TechnicianAnimalProfile-submit-item1" type="submit" onClick={addComment}>Submit</button>

                            <Table striped bordered hover className="TechnicianAnimalProfile-grid-item100" id="commentTable">
                                <thead>
                                    <tr>
